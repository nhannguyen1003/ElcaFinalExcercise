...
window.deleteMultiProject = function () {
    return __awaiter(this, void 0, void 0, function () {
        var checkedList, confirmMessage, errorMessage, errorInfo, errorList, i, projectIdEncode, err_1, contentOfMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    errorInfo = /** @class */ (function () {
                        function errorInfo(mes, relatedId) {
                ...
                case 1:
                    ...
                    projectIdEncode = checkedList[i].getAttribute("value");
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, deleteProject(projectIdEncode)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
                    ...
                    if (!errorMessage.includes(err_1.message)) {
                        ...
                        errorList.push(new errorInfo(err_1.message, projectIdEncode));
                    }
                    else {
...
//# sourceMappingURL=PIMDashboardScript.js.map