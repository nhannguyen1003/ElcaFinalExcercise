...
export class ProjectNumberField{
    static onLoadHandler(executionContext: Xrm.ExecutionContext<any, any>){
        //get fromContext
        const formContext = <Form.elca_project.Main.Information> executionContext.getFormContext();
        // disable field change if Project number is created
        var projectNumberFieldValue = getValueInFormContext(formContext,"elca_projectnumber");
