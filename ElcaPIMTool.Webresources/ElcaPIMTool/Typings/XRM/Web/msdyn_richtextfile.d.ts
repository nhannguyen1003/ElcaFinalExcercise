...
interface msdyn_richtextfile_Relationships {
  msdyn_fileblob?: FileAttachment_Result | null;
  ...
  msdyn_richtextfile_FileAttachments?: FileAttachment_Result[] | null;
...
interface msdyn_richtextfile_Expand {
  ...
  msdyn_fileblob: WebExpand<msdyn_richtextfile_Expand, FileAttachment_Select, FileAttachment_Filter, { msdyn_fileblob: FileAttachment_Result }>;
  ...
  msdyn_richtextfile_FileAttachments: WebExpand<msdyn_richtextfile_Expand, FileAttachment_Select, FileAttachment_Filter, { msdyn_richtextfile_FileAttachments: FileAttachment_Result[] }>;
...
interface msdyn_richtextfile_RelatedOne {
  ...
  msdyn_fileblob: WebMappingRetrieve<FileAttachment_Select,FileAttachment_Expand,FileAttachment_Filter,FileAttachment_Fixed,FileAttachment_Result,FileAttachment_FormattedResult>;
...
interface msdyn_richtextfile_RelatedMany {
  ...
  msdyn_richtextfile_FileAttachments: WebMappingRetrieve<FileAttachment_Select,FileAttachment_Expand,FileAttachment_Filter,FileAttachment_Fixed,FileAttachment_Result,FileAttachment_FormattedResult>;
