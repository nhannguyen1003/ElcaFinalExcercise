...
interface ActionCard_Expand {
  ...
  regardingobjectid_awcnpd_feedback: WebExpand<ActionCard_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { regardingobjectid_awcnpd_feedback: awcnpd_feedback_Result }>;
