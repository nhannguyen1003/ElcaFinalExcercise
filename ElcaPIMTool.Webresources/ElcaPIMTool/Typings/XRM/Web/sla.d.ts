...
interface SLA_Relationships {
  ...
  awcnpd_feedback_sla_slaid?: awcnpd_feedback_Result[] | null;
  awcnpd_feedback_sla_slainvokedid?: awcnpd_feedback_Result[] | null;
...
interface SLA_Expand {
  ...
  awcnpd_feedback_sla_slaid: WebExpand<SLA_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { awcnpd_feedback_sla_slaid: awcnpd_feedback_Result[] }>;
  awcnpd_feedback_sla_slainvokedid: WebExpand<SLA_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { awcnpd_feedback_sla_slainvokedid: awcnpd_feedback_Result[] }>;
...
interface SLA_RelatedMany {
  ...
  awcnpd_feedback_sla_slaid: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
  awcnpd_feedback_sla_slainvokedid: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
