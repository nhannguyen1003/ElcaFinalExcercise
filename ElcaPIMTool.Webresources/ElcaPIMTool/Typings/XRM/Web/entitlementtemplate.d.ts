...
interface EntitlementTemplate_Relationships {
  ...
  entitlementtemplate_awcnpd_feedbacks?: awcnpd_feedback_Result[] | null;
...
interface EntitlementTemplate_Expand {
  ...
  entitlementtemplate_awcnpd_feedbacks: WebExpand<EntitlementTemplate_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { entitlementtemplate_awcnpd_feedbacks: awcnpd_feedback_Result[] }>;
...
interface EntitlementTemplate_RelatedMany {
  ...
  entitlementtemplate_awcnpd_feedbacks: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
