...
interface ActivityParty_Relationships {
  ...
  activityid_awcnpd_feedback_activityparty?: awcnpd_feedback_Result | null;
...
interface ActivityParty extends ActivityParty_Base, ActivityParty_Relationships {
  ...
  activityid_awcnpd_feedback_activityparty_bind$awcnpd_feedbacks?: string | null;
...
interface ActivityParty_Expand {
  ...
  activityid_awcnpd_feedback_activityparty: WebExpand<ActivityParty_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { activityid_awcnpd_feedback_activityparty: awcnpd_feedback_Result }>;
...
interface ActivityParty_RelatedOne {
  ...
  activityid_awcnpd_feedback_activityparty: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
