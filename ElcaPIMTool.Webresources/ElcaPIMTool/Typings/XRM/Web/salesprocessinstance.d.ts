...
interface SalesProcessInstance_Relationships {
  organizationid?: BusinessUnit_Result | null;
...
interface SalesProcessInstance_Expand {
  organizationid: WebExpand<SalesProcessInstance_Expand, BusinessUnit_Select, BusinessUnit_Filter, { organizationid: BusinessUnit_Result }>;
...
interface SalesProcessInstance_RelatedOne {
  organizationid: WebMappingRetrieve<BusinessUnit_Select,BusinessUnit_Expand,BusinessUnit_Filter,BusinessUnit_Fixed,BusinessUnit_Result,BusinessUnit_FormattedResult>;
}
