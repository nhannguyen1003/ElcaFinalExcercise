...
interface KnowledgeBaseRecord_Relationships {
  ...
  knowledgebaserecord_awcnpd_feedbacks?: awcnpd_feedback_Result[] | null;
}
...
interface KnowledgeBaseRecord_Expand {
  ...
  knowledgebaserecord_awcnpd_feedbacks: WebExpand<KnowledgeBaseRecord_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { knowledgebaserecord_awcnpd_feedbacks: awcnpd_feedback_Result[] }>;
...
interface KnowledgeBaseRecord_RelatedMany {
  ...
  knowledgebaserecord_awcnpd_feedbacks: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
}
