...
interface InteractionForEmail_Relationships {
  ...
  interactionforemail_awcnpd_feedbacks?: awcnpd_feedback_Result[] | null;
...
interface InteractionForEmail_Expand {
  ...
  interactionforemail_awcnpd_feedbacks: WebExpand<InteractionForEmail_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { interactionforemail_awcnpd_feedbacks: awcnpd_feedback_Result[] }>;
...
interface InteractionForEmail_RelatedMany {
  ...
  interactionforemail_awcnpd_feedbacks: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
