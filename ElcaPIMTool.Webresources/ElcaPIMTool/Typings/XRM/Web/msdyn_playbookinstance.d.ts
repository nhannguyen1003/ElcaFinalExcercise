...
interface msdyn_playbookinstance_Relationships {
  ...
  msdyn_playbookinstance_awcnpd_feedbacks?: awcnpd_feedback_Result[] | null;
...
interface msdyn_playbookinstance_Expand {
  ...
  msdyn_playbookinstance_awcnpd_feedbacks: WebExpand<msdyn_playbookinstance_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { msdyn_playbookinstance_awcnpd_feedbacks: awcnpd_feedback_Result[] }>;
...
interface msdyn_playbookinstance_RelatedMany {
  ...
  msdyn_playbookinstance_awcnpd_feedbacks: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
}
