declare namespace Form.contact.Main {
  namespace Employee {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "elca_visa"): Xrm.Attribute<string>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "elca_visa"): Xrm.StringControl;
  ...
  interface Employee extends Xrm.PageBase<Employee.Attributes,Employee.Tabs,Employee.Controls> {
    ...
    getAttribute(attributeName: "elca_visa"): Xrm.Attribute<string>;
    ...
    getControl(controlName: "elca_visa"): Xrm.StringControl;
