declare namespace Form.product.Main {
  namespace Product {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdynsales_currentcost"): Xrm.NumberControl;
      get(name: "msdynsales_price"): Xrm.NumberControl;
      get(name: "msdynsales_standardcost"): Xrm.NumberControl;
  ...
  interface Product extends Xrm.PageBase<Product.Attributes,Product.Tabs,Product.Controls> {
    ...
    getControl(controlName: "msdynsales_currentcost"): Xrm.NumberControl;
    getControl(controlName: "msdynsales_price"): Xrm.NumberControl;
    getControl(controlName: "msdynsales_standardcost"): Xrm.NumberControl;
