declare namespace Form.incident.Main {
  namespace CaseforMultisessionexperience {
    namespace Tabs {
      interface AdditionalDetails extends Xrm.SectionCollectionBase {
        get(name: "AdditionalDetails_section_4"): Xrm.PageSection;
        get(name: "AdditionalDetails_section_5"): Xrm.PageSection;
        get(name: "AdditionalDetails_section_6"): Xrm.PageSection;
        get(name: "AdditionalDetails_section_7"): Xrm.PageSection;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "AdditionalDetails"): Xrm.PageTab<Tabs.AdditionalDetails>;
