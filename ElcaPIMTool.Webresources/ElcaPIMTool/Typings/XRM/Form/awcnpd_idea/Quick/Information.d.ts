declare namespace Form.awcnpd_idea.Quick {
  namespace Information {
    namespace Tabs {
    }
    interface Attributes extends Xrm.AttributeCollectionBase {
      get(name: "awcnpd_name"): Xrm.Attribute<string>;
      get(name: "awcnpd_targetmarketsize"): Xrm.NumberAttribute | null;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "awcnpd_targetmarketsize"): Xrm.NumberAttribute | null;
