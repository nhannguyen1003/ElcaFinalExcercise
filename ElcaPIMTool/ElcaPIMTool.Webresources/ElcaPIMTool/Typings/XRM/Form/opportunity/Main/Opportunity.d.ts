declare namespace Form.opportunity.Main {
  namespace Opportunity {
    namespace Tabs {
      ...
      interface Slider extends Xrm.SectionCollectionBase {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      get(name: "awc_new_isvalidated"): Xrm.OptionSetAttribute<boolean>;
      ...
      get(name: "ext_alcoholproduct"): Xrm.OptionSetAttribute<boolean>;
      get(name: "ext_canshipalcohol"): Xrm.OptionSetAttribute<boolean>;
      get(name: "ext_followupin"): Xrm.Attribute<string>;
      get(name: "ext_shippingtocountry"): Xrm.Attribute<string>;
      ...
      get(name: "prac_address1city"): Xrm.Attribute<string>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "WebResource_Date_Slider"): Xrm.WebResourceControl;
      get(name: "awc_new_isvalidated"): Xrm.OptionSetControl<boolean>;
      ...
      get(name: "ext_alcoholproduct"): Xrm.OptionSetControl<boolean>;
      get(name: "ext_canshipalcohol"): Xrm.OptionSetControl<boolean>;
      get(name: "ext_followupin"): Xrm.StringControl;
      get(name: "ext_shippingtocountry"): Xrm.StringControl;
      ...
      get(name: "prac_address1city"): Xrm.StringControl;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      ...
      get(name: "Slider"): Xrm.PageTab<Tabs.Slider>;
  ...
  interface Opportunity extends Xrm.PageBase<Opportunity.Attributes,Opportunity.Tabs,Opportunity.Controls> {
    getAttribute(attributeName: "awc_new_isvalidated"): Xrm.OptionSetAttribute<boolean>;
    ...
    getAttribute(attributeName: "ext_alcoholproduct"): Xrm.OptionSetAttribute<boolean>;
    getAttribute(attributeName: "ext_canshipalcohol"): Xrm.OptionSetAttribute<boolean>;
    getAttribute(attributeName: "ext_followupin"): Xrm.Attribute<string>;
    getAttribute(attributeName: "ext_shippingtocountry"): Xrm.Attribute<string>;
    ...
    getAttribute(attributeName: "prac_address1city"): Xrm.Attribute<string>;
    ...
    getControl(controlName: "WebResource_Date_Slider"): Xrm.WebResourceControl;
    getControl(controlName: "awc_new_isvalidated"): Xrm.OptionSetControl<boolean>;
    ...
    getControl(controlName: "ext_alcoholproduct"): Xrm.OptionSetControl<boolean>;
    getControl(controlName: "ext_canshipalcohol"): Xrm.OptionSetControl<boolean>;
    getControl(controlName: "ext_followupin"): Xrm.StringControl;
    getControl(controlName: "ext_shippingtocountry"): Xrm.StringControl;
    ...
    getControl(controlName: "prac_address1city"): Xrm.StringControl;
