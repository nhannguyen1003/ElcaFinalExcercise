...
interface Contact_Relationships {
  ...
  contact_awcnpd_feedbacks?: awcnpd_feedback_Result[] | null;
  ...
  elca_contact_elca_projectgroup?: elca_ProjectGroup_Result[] | null;
  elca_project_contact?: elca_Project_Result[] | null;
...
interface Contact_Select {
  ...
  elca_visa: WebAttribute<Contact_Select, { elca_visa: string | null }, {  }>;
...
interface Contact_Expand {
  ...
  contact_awcnpd_feedbacks: WebExpand<Contact_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { contact_awcnpd_feedbacks: awcnpd_feedback_Result[] }>;
  ...
  elca_contact_elca_projectgroup: WebExpand<Contact_Expand, elca_ProjectGroup_Select, elca_ProjectGroup_Filter, { elca_contact_elca_projectgroup: elca_ProjectGroup_Result[] }>;
  elca_project_contact: WebExpand<Contact_Expand, elca_Project_Select, elca_Project_Filter, { elca_project_contact: elca_Project_Result[] }>;
...
interface Contact_RelatedMany {
  ...
  contact_awcnpd_feedbacks: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
  ...
  elca_contact_elca_projectgroup: WebMappingRetrieve<elca_ProjectGroup_Select,elca_ProjectGroup_Expand,elca_ProjectGroup_Filter,elca_ProjectGroup_Fixed,elca_ProjectGroup_Result,elca_ProjectGroup_FormattedResult>;
  elca_project_contact: WebMappingRetrieve<elca_Project_Select,elca_Project_Expand,elca_Project_Filter,elca_Project_Fixed,elca_Project_Result,elca_Project_FormattedResult>;
