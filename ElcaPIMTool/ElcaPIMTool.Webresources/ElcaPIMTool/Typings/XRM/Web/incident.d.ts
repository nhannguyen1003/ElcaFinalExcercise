...
interface Incident_Relationships {
  ...
  incident_awcnpd_feedbacks?: awcnpd_feedback_Result[] | null;
...
interface Incident_Expand {
  ...
  incident_awcnpd_feedbacks: WebExpand<Incident_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { incident_awcnpd_feedbacks: awcnpd_feedback_Result[] }>;
...
interface Incident_RelatedMany {
  ...
  incident_awcnpd_feedbacks: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
