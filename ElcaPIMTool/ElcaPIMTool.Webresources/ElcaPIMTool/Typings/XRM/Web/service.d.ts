...
interface Service_Relationships {
  ...
  awcnpd_feedback_service_serviceid?: awcnpd_feedback_Result[] | null;
...
interface Service_Expand {
  ...
  awcnpd_feedback_service_serviceid: WebExpand<Service_Expand, awcnpd_feedback_Select, awcnpd_feedback_Filter, { awcnpd_feedback_service_serviceid: awcnpd_feedback_Result[] }>;
...
interface Service_RelatedMany {
  ...
  awcnpd_feedback_service_serviceid: WebMappingRetrieve<awcnpd_feedback_Select,awcnpd_feedback_Expand,awcnpd_feedback_Filter,awcnpd_feedback_Fixed,awcnpd_feedback_Result,awcnpd_feedback_FormattedResult>;
